...
# Definir contatos
contatos = ['Alas Medeiros Neto', 'Antônio Pena (Tabela1)', 'Gilvan Carlos Chagas', 'Bena Damasceno', 'Renato (Tabela 2)',
             ...
             'Aldo Itanhém', 'Jailson Itupeva', 'Itupeva - Jaílton', 'Roberto Lajedão', 'Ildeu Medeiros Neto', 'Núbia Medeiros Neto',
...
apelidos = ['Alas', 'Antônio', 'Gilvan', 'Bena', 'Renato', 'Silvana', 'Keila', 'Terezinha', 'Robson', 'Aílton', 'Kinho',
            'Neguinho', 'Lidão', 'Celso', 'Reinaldo', 'Rodomarck', 'Manoelton', 'Aldo', 'Jaílson', 'Jaílton', 'Roberto',
            'Ildeu', 'Núbia', 'Sílvio', 'Tiago', 'Douglas', 'Da Hora', 'Silvani', 'Raquel', 'Laís', 'André', 'Ademir',
