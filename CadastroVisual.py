...
janela = sg.Window('janelaCadastro', layout=layout)
...
while True:
    ...
    if evento == 'Enviar':
        if valores['clienteCadastro'] and valores['endereçoCadastro'] and valores['cidadeCadastro'] and valores['foneCadastro'] and valores['cnpjCadastro'] and valores['ieCadastro'] and valores['pagCadastro'] and valores['emailCadastro'] != '':
            #cabeçalho
            try:
