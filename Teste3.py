...
def main():
    ...
    layout = [[sg.Text('Process Killer - Choose one or more processes',
              ...
              [sg.Listbox(values=[' '], size=(90, 30), select_mode=sg.SELECT_MODE_EXTENDED, font=('Courier', 12),
                          key='-PROCESSES-')],
        ...
        if event == 'Sort by Name':
            ...
            for proc in processes_to_kill:
                ...
                try:
                    ...
                    sg.popup_non_blocking('Error killing process', auto_close_duration=2, auto_close=True,
                                          keep_on_top=True)
